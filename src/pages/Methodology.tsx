...
export function Methodology() {
  return (
    <>
      ...
      <Section kicker="Mechanism" title="Three tiers, in strict order" id="provenance">
        <Prose>
          <p>
            Every series on this site resolves through the same three-step ladder, and the figure
            tells you which step it landed on. Nothing renders silently.
          </p>
        </Prose>
          ...
          <table className="spec-table">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  Your browser called the publisher&rsquo;s API directly and it answered. No server
      ...
      <Section kicker="State of this release" title="What is verified, and what is not">
        <Prose>
          <p>
            ...
            provenance. The snapshot committed in this release &mdash; dated{' '}
            ...
            this site was built in had no outbound network access.
          </p>
          <p>
          ...
          <ul>
            <li>
              The {SERIES_TOTALS.live} API-backed series correct themselves the moment a reader
              loads the page with working network access. Those are the series to trust first.
            </li>
            <li>
            ...
            <li>
              Running <code>npm run refresh-data</code> regenerates every API-backed snapshot from
              the live publishers, stamps the new date, and clears the pending-verification flag. A
              scheduled workflow does the same thing weekly once the repository has network access.
            </li>
          </ul>
          <p>
